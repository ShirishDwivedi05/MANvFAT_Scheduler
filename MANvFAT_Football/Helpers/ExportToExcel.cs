...
namespace MANvFAT_Football.Helpers
{
    public static class CreateExcelFile_NPOI
    {
        ...
        public static XSSFCellStyle SetCellStyle_BGColor(ref XSSFWorkbook workbook, short FontColor, short BGColor)//IndexedColors.Lime.Index;
        {
            XSSFFont hFont = (XSSFFont)workbook.CreateFont();

           // hFont.Boldweight = (short)FontBoldWeight.Bold;
            hFont.Color = FontColor;
           // hFont.FontHeightInPoints = 18;

            var hStyle = (XSSFCellStyle)workbook.CreateCellStyle();
            hStyle.SetFont(hFont);
            hStyle.BorderBottom = BorderStyle.Medium;
            hStyle.FillForegroundColor = BGColor;
