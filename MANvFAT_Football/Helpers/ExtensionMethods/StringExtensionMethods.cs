...
namespace MANvFAT_Football.Helpers.ExtensionMethods
{
    ...
    public static class StringExtensionMethods
    {
        ...
        public static byte[] StringToRowVersion(this string rowVersion)
        {
        ...
        /// </summary>
        public static string EmptyStringToNothing(this string input)
        {
        ...
        /// </summary>
        public static bool YNStringToBool(this string input)
        {
        ...
        /// </summary>
        public static string TrimStringIfNotNull(this string input)
        {
        ...
        /// </summary>
        public static string UpperStringIfNotNull(this string input)
        {
        ...
        /// </summary>
        public static long StringToLong(this string input)
        {
