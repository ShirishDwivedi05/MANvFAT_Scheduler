...
namespace MANvFAT_Football.Models.Repositories
{
    public class PlayerDailyActivityRepository : BaseRepository
    {
        ...
        public void ShareActivity(ShareActivity model, Controller ctrl)
        {
            ...
            //Now Create CSV
            string fullFilePath = CreateCSV(ListOfActivitiesCSV, FileName, player.FullName, player.EmailAddress, ctrl);
        ...
        public string CreateCSV(List<PlayerDailyActivityCSV> ListOfActivities,string FileName, string PlayerName, string PlayerEmailAddress, Controller ctrl)
        {
            string CSVFilePath = "";
    ...
    public partial class PlayerDailyActivityExt
    {
        ...
        [DisplayName("HOW DO YOU FEEL ABOUT YOUR FOOD AND DRINK CHOICES?")]
