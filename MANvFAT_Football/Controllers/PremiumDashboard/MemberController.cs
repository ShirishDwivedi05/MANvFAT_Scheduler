...
using MANvFAT_Football.Helpers.ExtensionMethods;
...
namespace MANvFAT_Football.Controllers
{
    public class MemberController : BaseController
    {
        ...
        public ActionResult ForgottenPassword(ForgottenPasswordModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                using (DBEntities db = new DBEntities())
                {
                    ...
                    {
                        model.Reason = "Your provided email address is not valid. Please contact us at football@manvfat.com";
                        model.AlertType = "danger";
                    }
                }
            }
        ...
        {
            string errorMsg = "", alertType="danger";
            bool status = true;
            long PlayerID = 0;
            if (id != null)
            {
