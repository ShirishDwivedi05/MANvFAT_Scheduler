...
{
    public class ProgressDashboardController : BaseController
    {
        ...
        public ActionResult SaveWeightMeasurementData(PlayerMeasurementExt model)
        {
            string Msg = "";
            bool status = true;
            PlayerMeasurementsRepository pdaRepo = new PlayerMeasurementsRepository();
        ...
        public ActionResult Login(PlayerDashboardLogin model)
        {
            ...
            if (player != null)
            {
                ...
                var httpcookie = cookieRepo.CreateDashboardLoginCookie("abc",true);
        ...
        public ActionResult _GetPlayerYourWeight(long PlayerID, DateTime ActivityDate)
        {
            PlayerMeasurementsRepository pdaRepo = new PlayerMeasurementsRepository();
        ...
        public ActionResult _SaveWeightMeasurements(vmWeeklyActivity model)
        {
            PlayerWeeklyActivityExt m = new PlayerWeeklyActivityExt()
            {
                PlayerID = model.PlayerID,
        ...
        public ActionResult _RemoveWeightMeasurements(PlayerMeasurementExt model)
        {
            ...
            PlayerMeasurementsRepository pMeasurementRepo = new PlayerMeasurementsRepository();
            m.PlayerMeasurementID = pMeasurementRepo.CreateOrUpdate(m, ref Msg, ref status, this);
