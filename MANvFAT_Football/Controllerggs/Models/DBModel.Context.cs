...
namespace MANvFAT_Football.Models
{
    ...
    public partial class DBEntities : DbContext
    {
        ...
        public virtual DbSet<HowActives> HowActives { get; set; }
        ...
        public virtual DbSet<PlayerWeightWeeks> PlayerWeightWeeks { get; set; }
        ...
        public virtual ObjectResult<PlayersPaidForBook_TodayOnly_Result> PlayersPaidForBook_TodayOnly()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PlayersPaidForBook_TodayOnly_Result>("PlayersPaidForBook_TodayOnly");
        }
        ...
        public virtual ObjectResult<Nullable<long>> tmpSendEmail()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<long>>("tmpSendEmail");
        }
    
        public virtual int DeletePlayerReminders(string playerReminderIDs)
        {
            var playerReminderIDsParameter = playerReminderIDs != null ?
                new ObjectParameter("PlayerReminderIDs", playerReminderIDs) :
                new ObjectParameter("PlayerReminderIDs", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeletePlayerReminders", playerReminderIDsParameter);
        }
        ...
        public virtual ObjectResult<SelectStatsEmail_Result> SelectStatsEmail()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectStatsEmail_Result>("SelectStatsEmail");
        }
    
        public virtual ObjectResult<SelectPlayerWeightWeekLog_Result> SelectPlayerWeightWeekLog(Nullable<long> playerID)
        {
            var playerIDParameter = playerID.HasValue ?
                new ObjectParameter("PlayerID", playerID) :
                new ObjectParameter("PlayerID", typeof(long));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectPlayerWeightWeekLog_Result>("SelectPlayerWeightWeekLog", playerIDParameter);
        }
    
        public virtual ObjectResult<SelectPlayerWeightLogStats_Result> SelectPlayerWeightLogStats(Nullable<long> playerID)
        {
            var playerIDParameter = playerID.HasValue ?
                new ObjectParameter("PlayerID", playerID) :
                new ObjectParameter("PlayerID", typeof(long));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectPlayerWeightLogStats_Result>("SelectPlayerWeightLogStats", playerIDParameter);
        }
        ...
        public virtual ObjectResult<Nullable<bool>> rpt_5PercentPlayerStat(Nullable<int> targetLossWithinWeek, Nullable<decimal> targetPercent, Nullable<long> playerID, Nullable<long> leagueID, Nullable<System.DateTime> leagueStartDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<bool>>("rpt_5PercentPlayerStat", targetLossWithinWeekParameter, targetPercentParameter, playerIDParameter, leagueIDParameter, leagueStartDateParameter);
        }
        ...
        public virtual ObjectResult<Nullable<long>> InsertPlayer_FromPlayersArchive(Nullable<long> player_ArchiveID)
        {
            var player_ArchiveIDParameter = player_ArchiveID.HasValue ?
                new ObjectParameter("Player_ArchiveID", player_ArchiveID) :
                new ObjectParameter("Player_ArchiveID", typeof(long));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<long>>("InsertPlayer_FromPlayersArchive", player_ArchiveIDParameter);
        }
    
        public virtual ObjectResult<SelectPlayersTotalNumWeeks_BMIUnder25_Result> SelectPlayersTotalNumWeeks_BMIUnder25(Nullable<long> playerID, Nullable<int> currentWeek)
        {
            var playerIDParameter = playerID.HasValue ?
                new ObjectParameter("PlayerID", playerID) :
                new ObjectParameter("PlayerID", typeof(long));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectPlayersTotalNumWeeks_BMIUnder25_Result>("SelectPlayersTotalNumWeeks_BMIUnder25", playerIDParameter, currentWeekParameter);
        }
    
        public virtual ObjectResult<SelectPlayers_Result> SelectPlayers(Nullable<long> coachUserID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectPlayers_Result>("SelectPlayers", coachUserIDParameter);
        }
    
        public virtual ObjectResult<SelectPlayerProgressImages_Result> SelectPlayerProgressImages(Nullable<long> playerID, Nullable<long> leagueFixtureID)
        {
            var playerIDParameter = playerID.HasValue ?
                new ObjectParameter("PlayerID", playerID) :
                new ObjectParameter("PlayerID", typeof(long));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectPlayerProgressImages_Result>("SelectPlayerProgressImages", playerIDParameter, leagueFixtureIDParameter);
        }
        ...
        public virtual int rpt_09_TopScorerPerLeague(Nullable<long> leagueID)
        {
            var leagueIDParameter = leagueID.HasValue ?
                new ObjectParameter("LeagueID", leagueID) :
                new ObjectParameter("LeagueID", typeof(long));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("rpt_09_TopScorerPerLeague", leagueIDParameter);
        }
