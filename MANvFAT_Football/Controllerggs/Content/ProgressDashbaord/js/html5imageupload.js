...
(function (window, $, undefined) {
	...
	$.html5imageupload = function html5imageupload(options, element) {
		...
		//buttons
		this.button				= {}
		this.button.edit		= '<div class="img-opt-cropit img-edit-cropit" title="' + (this.options.editTitle || 'Edit') + '"><i class="far fa-edit"></i></div>'
		this.button.saving		= '<div class="img-opt-cropit img-time-cropit">' + (this.options.saveLabel || 'Saving...') + ' <i class="far fa-clock"></i></div>';
		this.button.zoomin		= '<div class="img-opt-cropit img-zoom-cropit" title="' + (this.options.zoominTitle || 'Zoom in') + '"><i class="glyphicon glyphicon-resize-full"></i></div>';
		this.button.zoomout		= '<div class="img-opt-cropit img-zoom-cropit" title="' + (this.options.zoomoutTitle || 'Zoom out') + '"><i class="glyphicon glyphicon-resize-small"></i></div>';
		this.button.zoomreset	= '<div class="img-opt-cropit img-full-cropit" title="' + (this.options.zoomresetTitle || 'Fullsize') + '"><i class="fas fa-expand"></i></div>';
...
//		this.button.rotateccw	= '<div class="btn btn-default btn-rotate-ccw" title="' + (this.options.ccwTitle || 'Rotate counter clockwise') + '"><i class="glyphicon glyphicon-share icon-flipped"></i></div>';
		this.button.cancel		= '<div class="img-opt-cropit img-close-cropit" title="' + (this.options.cancelTitle || 'Cancel') + '"><i class="fas fa-times"></i></div>';
		this.button.done		= '<div class="img-opt-cropit img-valid-cropit" title="' + (this.options.okTitle || 'Ok') + '"><i class="glyphicon glyphicon-ok"></i></div>';
		this.button.del			= '<div class="img-opt-cropit img-remove-cropit" title="' + (this.options.delTitle || 'Delete') + '"><i class="glyphicon glyphicon-trash"></i></div>';
		
		this.button.download	= '<a class="img-opt-cropit img-dwnl-cropit"><i class="glyphicon glyphicon-download-alt"></i> ' + (this.options.downloadLabel || 'Download') + '</a>';
